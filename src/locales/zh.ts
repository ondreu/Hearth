...
export const zh: Translations = {
	...
	portable: {
		exportModal: {
			...
			snapshotConfirmDesc:
				"请点开大图，逐处读一遍。卡片标题、标题栏，以及卡片中本就不属于你的内容可以保留；笔记正文、任务、文件名、日程、和你生活有关的数字则不应出现。确认之后才能发布。",
			snapshotConfirmRequired:
				"请先看过图片，再打开“我看过了”——这是面板公开之前的最后一道关。",
			snapshotLeak:
				"图里能读到你的内容？请不要发布这个面板——这是涂抹功能的缺陷，而文件一旦被别人复制就再也收不回来。",
